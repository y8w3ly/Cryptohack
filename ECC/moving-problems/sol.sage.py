...
Gx = G.xy()[_sage_const_0 ]
Gy = G.xy()[_sage_const_1 ]
#P1 = (1110072782478160369250829345256 : 800079550745409318906383650948 : 1) which is [n_a]*G :
P1 = E(_sage_const_1110072782478160369250829345256  , _sage_const_800079550745409318906383650948 )
Qx = P1.xy()[_sage_const_0 ]
Qy = P1.xy()[_sage_const_1 ]
...
pt = unpad(cipehr.decrypt(ct),_sage_const_16 )
print(pt.decode())
